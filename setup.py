...
def main():
    ...
    setup(
        name="ctodd-python-lib-mysql",
        version=version,
        python_requires=">3.0,<3.7",
        description=("Python utilities used for interacting with MySQL"),
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-mysql",
        author="Christopher H. Todd",
        author_email="Christopher.Hayden.Todd@gmail.com",
        classifiers=["Programming Language :: Python"],
        keywords=["python", "libraries", "MySQL", "mysqldb"],
        packages=packages,
